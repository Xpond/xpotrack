    ...
    fun notes(now: Long): List<NoteEntity> {
        ...
        return listOf(
            ...
            NoteEntity(title = "On finishing things",
                ...
                category = "Essay",
                createdAt = now - 6 * day, updatedAt = now - 3 * day, recency = 6),
            NoteEntity(title = "Pasta dough",
                bodyMarkdown = "100g 00 flour · 1 egg · pinch salt · rest 30m wrapped",
                category = "Recipe",
                createdAt = now - 5 * day, updatedAt = now - 4 * day, recency = 5),
            NoteEntity(title = "Talk feedback — Anya",
                ...
                category = "Work",
                createdAt = now - 4 * day, updatedAt = now - 18 * day, recency = 4),
            ...
            NoteEntity(title = "Q2 planning",
                ...
                createdAt = now - 1 * day, updatedAt = now - 26 * day, recency = 1),
            NoteEntity(title = "Shower thought",
                bodyMarkdown = "A todo list is just a note that yells at you.",
                category = "Inbox",
                createdAt = now, updatedAt = now - 28 * day, recency = 0),
        )
    }
